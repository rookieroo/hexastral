 ...
 */
export function ExpandScrollIcon({ size = 24, color = 'currentColor', strokeWidth = 1.5, ...rest }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...rest}>
      {/* top scroll curl */}
      <Path d="M7 4c0-1 1-2 2.5-2h5c1.5 0 2.5 1 2.5 2" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
      {/* scroll body */}
      <Path d="M7 4v16c0 1 1 2 2.5 2h5c1.5 0 2.5-1 2.5-2V4" stroke={color} strokeWidth={strokeWidth} strokeLinejoin="round" />
      {/* expand arrows — centre, pointing out */}
      <Path d="M12 8v8M9 10.5L12 8l3 2.5M9 13.5l3 3 3-3" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  )
}
 ...
 */
export function ShareIcon({ size = 24, color = 'currentColor', strokeWidth = 1.5, ...rest }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...rest}>
      {/* top node */}
      ...
      {/* connecting lines */}
      <Path d="M8.3 10.8l7.4-4.6M8.3 13.2l7.4 4.6" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
    </Svg>
  )
}
 ...
 */
export function BrushEditIcon({ size = 24, color = 'currentColor', strokeWidth = 1.5, ...rest }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...rest}>
 ...
 */
export function LanguageIcon({ size = 24, color = 'currentColor', strokeWidth = 1.5, ...rest }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...rest}>
      {/* globe circle */}
      ...
      {/* meridian arcs */}
      <Path d="M12 2.5c-3 2-4.5 5-4.5 9.5s1.5 7.5 4.5 9.5" stroke={color} strokeWidth={strokeWidth * 0.7} />
      <Path d="M12 2.5c3 2 4.5 5 4.5 9.5s-1.5 7.5-4.5 9.5" stroke={color} strokeWidth={strokeWidth * 0.7} />
      {/* latitude line */}
      <Path d="M5.5 7h13M5.5 17h13" stroke={color} strokeWidth={strokeWidth * 0.5} strokeLinecap="round" opacity={0.4} />
    </Svg>
  )
}
 ...
 */
export function BackArrowIcon({ size = 24, color = 'currentColor', strokeWidth = 1.5, ...rest }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...rest}>
      <Path
        d="M10 5L3 12l7 7"
 ...
 */
export function CloseIcon({ size = 24, color = 'currentColor', strokeWidth = 1.5, ...rest }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...rest}>
      <Path
 ...
 */
export function SettingsIcon({ size = 24, color = 'currentColor', strokeWidth = 1.5, ...rest }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...rest}>
      {/* slider tracks */}
      <Path d="M4 6h16M4 12h16M4 18h16" stroke={color} strokeWidth={strokeWidth * 0.6} strokeLinecap="round" opacity={0.3} />
 ...
 */
export function NotificationIcon({ size = 24, color = 'currentColor', strokeWidth = 1.5, ...rest }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...rest}>
      {/* bell body */}
      <Path
      ...
      />
      {/* clapper */}
      <Path d="M9.5 19c.5 1.5 1.3 2.5 2.5 2.5s2-1 2.5-2.5" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
    </Svg>
  )
}
 ...
 */
export function ChevronDownIcon({ size = 24, color = 'currentColor', strokeWidth = 1.5, ...rest }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...rest}>
      <Path
        d="M6 9l6 6 6-6"
 ...
 * ChevronRightIcon (进入)
 */
export function ChevronRightIcon({ size = 24, color = 'currentColor', strokeWidth = 1.5, ...rest }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...rest}>
      <Path
        d="M9 6l6 6-6 6"
 ...
 */
export function SearchIcon({ size = 24, color = 'currentColor', strokeWidth = 1.5, ...rest }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...rest}>
 ...
 */
export function CollapseScrollIcon({ size = 24, color = 'currentColor', strokeWidth = 1.5, ...rest }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...rest}>
      {/* scroll body */}
      <Path d="M7 4c0-1 1-2 2.5-2h5c1.5 0 2.5 1 2.5 2v16c0 1-1 2-2.5 2h-5C8 22 7 21 7 20V4z" stroke={color} strokeWidth={strokeWidth} strokeLinejoin="round" />
      {/* collapse arrows — pointing inward */}
      <Path d="M9 7.5L12 10.5l3-3M9 16.5l3-3 3 3" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
    </Svg>
  )
}
