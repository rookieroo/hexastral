 ...
 */
export function WuxingMetalIcon({ size = 24, color = 'currentColor', strokeWidth = 1.5, ...rest }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...rest}>
      ...
      <Path d="M12 3v10L8 21" stroke={color} strokeWidth={strokeWidth * 0.6} strokeLinecap="round" opacity={0.4} />
    </Svg>
  )
}
 ...
 */
export function WuxingWoodIcon({ size = 24, color = 'currentColor', strokeWidth = 1.5, ...rest }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...rest}>
      {/* trunk */}
      ...
      <Path d="M12 18l4.5 2.5" stroke={color} strokeWidth={strokeWidth * 0.9} strokeLinecap="round" />
    </Svg>
  )
}
 ...
 */
export function WuxingWaterIcon({ size = 24, color = 'currentColor', strokeWidth = 1.5, ...rest }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...rest}>
      ...
      <Path d="M4 11c2-1.5 4.5-1.5 8 0s6 1.5 8 0" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
      <Path d="M3 15.5c2.5-2 5-2 9 0s6.5 2 9 0" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
      <Path d="M4 20c2-1.5 4.5-1.5 8 0s6 1.5 8 0" stroke={color} strokeWidth={strokeWidth * 0.8} strokeLinecap="round" opacity={0.6} />
    </Svg>
  )
}
 ...
 */
export function WuxingFireIcon({ size = 24, color = 'currentColor', strokeWidth = 1.5, ...rest }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...rest}>
      {/* outer flame */}
      <Path
 ...
 */
export function WuxingEarthIcon({ size = 24, color = 'currentColor', strokeWidth = 1.5, ...rest }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...rest}>
      {/* primary peak */}
      <Path d="M3 19L10 6l4 7 4-3 4 9" stroke={color} strokeWidth={strokeWidth} strokeLinejoin="round" strokeLinecap="round" />
      {/* ground line */}
 ...
 */
export function YinYangIcon({ size = 24, color = 'currentColor', strokeWidth = 1.5, ...rest }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...rest}>
      {/* outer circle */}
      ...
      {/* S-curve divider */}
      <Path
        d="M12 2c0 5.5-3 5.5-3 10s3 4.5 3 10"
        stroke={color}
        strokeWidth={strokeWidth}
      />
 ...
 */
export function SealStampIcon({ size = 24, color = 'currentColor', strokeWidth = 1.5, ...rest }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...rest}>
      ...
      <Path d="M8 8h8M12 8v8M8.5 13h7" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
    </Svg>
  )
}
 ...
 */
export function DaYunIcon({ size = 24, color = 'currentColor', strokeWidth = 1.5, ...rest }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...rest}>
      {/* timeline axis */}
      <Path d="M3 12h18" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" />
      {/* arrow tip */}
      <Path d="M18 8.5l3 3.5-3 3.5" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" />
      {/* decade tick marks */}
      <Path d="M6 9v6M10 10v4M14 10v4M18 9v6" stroke={color} strokeWidth={strokeWidth * 0.8} strokeLinecap="round" />
      {/* active segment highlight */}
      <Path d="M6 12h8" stroke={color} strokeWidth={strokeWidth * 2.5} strokeLinecap="round" opacity={0.2} />
    </Svg>
  )
}
 ...
 */
export function LiuNianIcon({ size = 24, color = 'currentColor', strokeWidth = 1.5, ...rest }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...rest}>
      {/* timeline axis */}
      <Path d="M3 16h18" stroke={color} strokeWidth={strokeWidth * 0.7} strokeLinecap="round" opacity={0.4} />
      ...
      <Path d="M6 14v2M9 13.5v2.5M15 13.5v2.5M18 14v2" stroke={color} strokeWidth={strokeWidth * 0.6} strokeLinecap="round" opacity={0.3} />
    </Svg>
  )
}
 ...
 */
export function TrigramIcon({ size = 24, color = 'currentColor', strokeWidth = 1.5, ...rest }: IconProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none" {...rest}>
