...
export function AlmanacIcon({
  ...
  return (
    <Svg width={size} height={size} viewBox='0 0 24 24' fill='none' {...rest}>
      {/* page body */}
      <Path d='M5 4h14v17H5V4z' stroke={color} strokeWidth={strokeWidth} strokeLinejoin='round' />
      {/* top binding holes — two small marks */}
      <Path
        d='M9 4v-1.5M15 4v-1.5'
        stroke={color}
        strokeWidth={strokeWidth}
        strokeLinecap='round'
      />
 ...
 */
export function NumerologyIcon({
  size = 24,
  color = 'currentColor',
  strokeWidth = 1.5,
  ...rest
  ...
  return (
    <Svg width={size} height={size} viewBox='0 0 24 24' fill='none' {...rest}>
      ...
      <Path d='M5 12.5h15' stroke={color} strokeWidth={strokeWidth * 1.3} strokeLinecap='round' />
    </Svg>
  )
}
