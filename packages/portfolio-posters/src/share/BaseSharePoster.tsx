  ...
  return (
    ...
    >
      <View style={{ gap: 10 }}>
        ...
        <Text
          style={{ color: darkTokens.text, fontSize: 30, fontWeight: '300', letterSpacing: 1.5 }}
        >
          {props.title}
        </Text>
        {props.subtitle ? (
          <Text style={{ color: darkTokens.secondary, fontSize: 14, lineHeight: 22 }}>
            {props.subtitle}
          </Text>
        ) : null}
      ...
      <View style={{ gap: 12 }}>
        ...
        >
          <Text style={{ color: darkTokens.dim, fontSize: 10, letterSpacing: 2 }}>
