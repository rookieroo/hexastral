      ...
      >
        ...
        <View style={{ alignItems: 'center', gap: yuanSpacing.xl, marginTop: yuanSpacing.xxl }}>
          ...
          <View style={{ alignItems: 'center', gap: yuanSpacing.sm }}>
            ...
            <Text style={[yuanType.body, { color: yuanLight.textSecondary, textAlign: 'center' }]}>
              {state === 'pending'
        ...
        {state === 'pending' && (
          <View style={{ alignItems: 'center', gap: yuanSpacing.lg }}>
            ...
            {linkEmailHint && onLinkEmail ? (
              <Pressable onPress={onLinkEmail} hitSlop={12} style={{ marginTop: yuanSpacing.sm }}>
                <Text style={[yuanType.caption, { color: yuanLight.accent, textAlign: 'center' }]}>
                  {linkEmailHint}
                </Text>
              </Pressable>
            ) : null}
