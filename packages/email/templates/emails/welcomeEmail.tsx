 ...
 */
export const WelcomeEmailTemplate: React.FC<WelcomeEmailTemplateProps> = ({ planName }) => {
  ...
  return (
    ...
    >
      <ContentSection>
        ...
        <Text className='mb-6 text-gray-600 leading-relaxed'>{planBenefits.welcomeMessage}</Text>
