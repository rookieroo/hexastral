 ...
 *   t=2000  Cinnabar Kindred seal stamps down (scale 1.5→1.0, rotate -8→0, 320ms)
    ...
    <View style={styles.root}>
      ...
      >
        {STRANDS.map((strand, i) => (
          <ConnectingThread key={i} strand={strand} progress={lineProgress} waft={waftPhase} />
        ))}
      </Svg>
      ...
      <View style={styles.sealAnchor} pointerEvents='none'>
        <Animated.View style={[styles.seal, sealStyle]}>
          <Text style={styles.sealGlyph}>Kindred</Text>
        </Animated.View>
      </View>

      {/* Text lines */}
      <View style={styles.textBlock} pointerEvents='none'>
        <Animated.Text style={[kindredType.title, styles.textLine, text1Style]}>
          {merged.line1}
        </Animated.Text>
        <Animated.Text style={[kindredType.title, styles.textLine, text2Style]}>
          {merged.line2}
        </Animated.Text>
      </View>
