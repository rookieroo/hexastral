 ...
 * supporting context (chapter title, two bond names, Kindred cinnabar seal).
...
export function ShareableChapterCard({
  ...
  return (
    ...
    >
      {/* Top — chapter marker */}
      <View style={{ alignItems: 'center', gap: s(kindredSpacing.md) }}>
        <Text
          style={{
            fontSize: s(kindredType.seal.fontSize),
            lineHeight: s(kindredType.seal.lineHeight),
            fontWeight: '700',
            letterSpacing: s(kindredType.seal.letterSpacing),
            color: ink.brown,
      ...
      <View style={{ alignItems: 'center', gap: s(kindredSpacing.lg) }}>
        <Text
          style={{
            fontSize: s(36),
            lineHeight: s(48),
