...
import { CHROMATIC_COLORS, type ColorFamily, TAILWIND_COLORS } from './tailwind-palette'
...
function createColorTheme(
  family: ColorFamily,
  overrides?: Partial<Omit<ThemePreset, 'preset'>> & {
    preset?: Partial<ThemePreset['preset']>
  }
): ThemePreset {
