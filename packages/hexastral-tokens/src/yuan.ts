/**
 * Yuán (緣) — application rules for the synastry product.
 *
 ...
 * Yuán. The base tokens (rubbing, ricePaper, cinnabar, ink, zinc) are NOT
 ...
 *   - Yuán aesthetic = same rice paper, two cinnabar seals connecting (warmer,
...
// ── Semantic theme — light mode (default for Yuán) ──────────────────────────

export const yuanLight = {
  // Surfaces
  bg: ricePaper.ivory,
...
export type YuanTheme = typeof yuanLight

// ── Typography ──────────────────────────────────────────────────────────────

export const yuanType = {
...
export const yuanPresets = {
  ...
  /** Cinnabar 緣 seal container — round red ground, gold glyph */
  sealCircle: {
    backgroundColor: cinnabar.seal,
    width: 96,
    height: 96,
    borderRadius: yuanRadius.full,
    alignItems: 'center' as const,
    justifyContent: 'center' as const,
  },
  /** Hero CJK glyph (緣 / 命 / 風) — used in welcome and brand marks */
  heroGlyph: {
    fontSize: 120,
    lineHeight: 140,
    color: cinnabar.seal,
