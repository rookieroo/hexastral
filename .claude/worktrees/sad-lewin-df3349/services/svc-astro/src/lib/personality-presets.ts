 ...
 * 命格预设人格画像 — 确定性兖底库
 *
 * 用途：当 Gemini Flash 超时或失败时返回的命格派生人格内容。
...
const STEM_PROFILES: Record<string, LocaleMap<PresetPersonality>> = {
  ...
  丁: {
    ...
    en: {
      ...
      fateTease: "That fire you've never fully spoken aloud is approaching the point of being seen…",
  ...
  戊: {
    ...
    en: {
      ...
      fateTease: 'The version of you buried beneath all that reliability has been waiting for a long time…',
  ...
  己: {
    ...
    en: {
      ...
      warning: "The quietest part of you holds the most important answer, and you haven't listened yet…",
    },
  },
  庚: {
    zh: {
  ...
  辛: {
    ...
    en: {
      ...
      warning: 'What you frame as high standards sometimes blocks exactly what you are waiting for…',
    },
  },
  壬: {
    zh: {
  ...
  癸: {
    ...
    en: {
      ...
      fateTease: "The weight of something from your past is finding its way back into your present…",
      warning: "When you absorb everyone else's emotional world, finding your own voice becomes the work…",
    },
  },
}
...
const EMERGENCY_FALLBACK_EN: PresetPersonality = {
  personalityBullets: ['Chart analysis in progress', 'Your four pillars hold the answer', 'The pattern is already written'],
