...
import { BRANCH_WUXING, STEM_WUXING, EARTHLY_BRANCHES, HEAVENLY_STEMS } from '../constants'
import { NAJIA_TABLE, TRIGRAM_PAIR_TO_HEXAGRAM, LINES_TO_TRIGRAM } from './najia-table'
import type {
  YaoLine,
  YaoIndex,
  YaoValue,
