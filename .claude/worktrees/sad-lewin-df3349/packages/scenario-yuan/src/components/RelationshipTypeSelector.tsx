...
import { yuanLight, yuanType, yuanSpacing, yuanRadius } from '@zhop/hexastral-tokens/yuan'
        ...
        return (
          <Pressable
            ...
            style={{
              ...
              borderRadius: yuanRadius.sm,
              backgroundColor: isSelected ? yuanLight.accent : 'transparent',
              borderWidth: 0.5,
              borderColor: isSelected ? yuanLight.accent : yuanLight.border,
            }}
          >
            <Text
              style={{
                ...yuanType.caption,
                color: isSelected ? yuanLight.bg : yuanLight.text,
              }}
            >
              {merged[rt]}
            </Text>
