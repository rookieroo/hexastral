...
export function DreamSharePoster(props: DomainPosterProps) {
  return (
    <BaseSharePoster title='DreamOracle' subtitle={props.headline} shareUrl={props.shareUrl}>
      <Text style={{ color: '#A1A1AA', fontSize: 13, lineHeight: 20 }}>
...
export function FaceOracleSharePoster(props: DomainPosterProps) {
  return (
    <BaseSharePoster title='FaceOracle' subtitle={props.headline} shareUrl={props.shareUrl}>
      <Text style={{ color: '#A1A1AA', fontSize: 13, lineHeight: 20 }}>
