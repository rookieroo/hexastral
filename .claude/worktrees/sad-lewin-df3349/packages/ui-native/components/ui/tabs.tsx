...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      className={cn(
        'bg-muted flex h-9 flex-row items-center justify-center rounded-none p-[3px]',
  ...
  return (
    ...
    >
      <TabsPrimitive.Trigger
        className={cn(
          'flex h-[calc(100%-1px)] flex-row items-center justify-center gap-1.5 rounded-none border border-transparent px-2 py-1 shadow-none shadow-black/5',
          Platform.select({
