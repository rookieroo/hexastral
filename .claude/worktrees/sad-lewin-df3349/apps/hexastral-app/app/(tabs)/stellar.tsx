import type { ChartMeta, FateStellarChart, PalaceSummary, ReadingRecord } from '@zhop/hexastral-client'
import { StellarOverviewCard, ZiweiPalaceCard } from '@zhop/scenario-ziwei'
    ...
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: colors.background }}>
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', padding: 24 }}>
          <Text style={{ color: colors.textSecondary, textAlign: 'center' }}>{t('stellar_tab_parse_error')}</Text>
        </View>
      </SafeAreaView>
    )
  }
