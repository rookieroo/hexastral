...
export default function YouScreen() {
  ...
  useEffect(() => {
    ...
    setChartPublic(true)
    void saveProfileRef.current({ chartPublic: true }).then((ok) => {
      if (!ok) {
      ...
      >
        ...
        >
          ...
          <PublicVisibilityPanel
            ...
            hasUsername={isUsernameEligibleForPublicVisibility(remoteUser?.username ?? profile.username)}
  ...
  return (
    <>
      ...
      >
        ...
        />
        <SettingsRow
          label='Open Ask the Master'
          hint='Empty chat from latest fate reading'
          onPress={() => router.push('/(tabs)/void')}
          colors={colors}
        />
      </View>
