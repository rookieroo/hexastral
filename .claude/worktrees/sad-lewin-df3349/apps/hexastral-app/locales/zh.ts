...
export const zh = {
  ...
  history_delete_pair: '将从命册中移除该条合盘记录。若已与「缘分」中的 Cosmic Bond 关联，请先删除对应 Bond。',
...
• 所有解读仅为参考，命运掌握在自己手中`,
  before_reading_modal_body_meihua: `步骤
① 输入你的具体问题
② 随意观察周围，记录一个自然出现的数字
③ 将数字填入（或留空由系统随机生成）
④ AI 以体卦、用卦演算当下时势
...
所有解读为参考，命运掌握在自己手中`,
  ...
  about_meihua_body:
    '梅花易数由北宋邵雍所创，以一个随机数字（或当下所见之物）起卦，通过体卦与用卦的对比关系，演算当前事件的走势与结局。其核心是"以数观象"——宇宙的规律藏在任何偶遇的数字之中。',
  ...
  ob_social_label: '星象缘分',
  ob_social_q: '探索星象如何\n连结你与他人。',
  ob_social_resonance: '共鸣度',
  ob_social_note: '无需通讯录 — 只需生辰信息。',
  ob_social_cta: '踏入星河',
  ob_today_label: '今日',
  ob_today_natal: '命主年柱',
  ...
  home_bonds_title: '星象缘分',
  home_bonds_desc: '点击探索你的关系星图。',
  ...
  explore_palmface_title: '面相预览',
  explore_palmface_body: '拍摄人像以生成结构化预览解读，与 Face Oracle 卫星共用同一套 portfolio 管线。',
  explore_palmface_open_camera: '打开相机',
  explore_palmface_back: '← 返回',
  explore_palmface_status_idle: '尚未拍照',
  explore_palmface_status_denied: '未获得相机权限',
  explore_palmface_status_cancelled: '已取消',
  explore_palmface_status_working: '已拍照，正在生成解读…',
  explore_palmface_error: '预览失败，请重试。',
  explore_palmface_features_title: '部位要点',

  // Bonds — 缘分关系
  bonds_subtitle: '探索你与重要之人之间的星象缘分。',
  bonds_radar_title: '关系全局',
  bond_dim_long_term: '长期',
  bond_dim_attraction: '吸引',
  bond_dim_communication: '沟通',
  bond_dim_emotional: '情感',
  bonds_create_cta: '新建缘分',
  bonds_view_all: '查看全部',
  bonds_self: '我',
  bonds_explore: '探索 →',
  bonds_lover: '恋人',
  bonds_lover_desc: '情感共鸣、相互吸引、长期契合度深度解读。',
  bonds_lover_score: '情缘指数',
  bonds_lover_summary: '心意相通',
  bonds_family: '家人',
  bonds_family_desc: '父母、兄弟、子女 — 因缘纽带与相处之道。',
  bonds_family_score: '亲缘指数',
  bonds_family_summary: '血脉共振',
  bonds_colleague: '同事',
  bonds_colleague_desc: '协作默契、沟通风格、团队能量流动。',
  bonds_colleague_score: '协作指数',
  bonds_colleague_summary: '气场互补',
  bonds_boss: '贵人',
  bonds_boss_desc: '权力共振 — 器重度、信任感与事业助力。',
  bonds_boss_score: '贵人指数',
  bonds_boss_summary: '相得益彰',
  bonds_score_label: '契合度',
  bonds_analysis_pending: '录入对方生辰即可解锁',
  bonds_hint: '输入双方生辰即可解锁深度缘分分析。',
  bonds_invite: '邀请好友',
  bonds_invite_desc: '分享给通讯录好友，探索你们的星象缘分。',
  bonds_invite_cta: '发送邀请',
  bonds_matched: '已连接',
  bonds_pending: '等待中',
  bonds_invite_msg: '探索我们之间的星象缘分 — 下载HexAstral，录入你的生辰：',
  bonds_add_contact: '添加联系人',
  bonds_contact_section: '通讯录好友',
  bonds_virtual_hint: '邀请好友解锁真实关系网',
  bonds_enter_starfield: '探索星空',
  bonds_starfield_hint: '双指缩放切换视图',
  bonds_starfield_demo: '演示',
  bonds_starfield_bonds_n: '{n} 个缘分',
  bonds_starfield_active_n: '{n} 活跃',
  bonds_vibe_chosen: '天选之人',
  bonds_vibe_contract: '灵魂契约',
  bonds_vibe_fated: '命中注定',
  bonds_vibe_sync: '心有灵犀',
  bonds_vibe_tacit: '默契十足',
  bonds_vibe_attract: '互相吸引',
  bonds_vibe_spark: '来电感觉',
  bonds_vibe_affinity: '缘分不错',
  bonds_vibe_plain: '平淡如水',
  bonds_vibe_effort: '需要磨合',
  // Legacy friends keys
  friends_empty_title: '你的星际还很安静',
  friends_empty_body: '邀请好友加入，探索你们之间的宇宙连接',
  friends_invite: '邀请好友',
  friends_compatibility: '合盘配对',
  friends_compatibility_hint: '探索你与好友的星盘契合度',
  ...
  bonds_your_connections: '你的缘分',
  bonds_add_contacts: '添加通讯录好友',
  contacts_title: '通讯录',
  contacts_on_hexastral: '已在HexAstral',
  contacts_invite_section: '邀请',
  contacts_permission_denied: '请在设置中允许访问通讯录',
  contacts_loading: '加载中...',
  contacts_invited: '已邀请',
  contacts_invite_btn: '邀请',
  contacts_hint:
    '通讯录仅用于在HexAstral查找好友。手机号经服务器匹配后，不会被存储或分享给第三方。',
  bond_detail_dimensions: '契合维度',
  bond_detail_unlock_hint: '解锁完整深度分析',
  bond_detail_unlock_cta: '解锁合盘',
  ...
  bond_invite_share: '邀请加入',
  bond_invite_message: '来 HexAstral 探索我们的命理契合度吧！{url}',
  bond_gift_cta: '赠送完整解读给对方',
  bond_gift_done: '完整解读已赠出',
  bond_locked_hint: '3个维度已锁定 — 解锁以查看完整命缘分析',
  leaderboard_title: '命缘排行榜',
  leaderboard_soul_match: '灵魂契合',
  leaderboard_fatal_attraction: '命定吸引',
  leaderboard_cosmic_friction: '命运摩擦',
  leaderboard_karmic_anchor: '业力锚点',
  leaderboard_cold_start: '再邀请 {n} 位朋友以解锁命缘排行榜',

  // Bonds — dual-mode create & accept
  bond_create_title: '建立关系',
  bond_create_desc: '选择一种方式了解你和TA的命理契合度',
  bond_mode_solo: '默念',
  bond_mode_solo_desc: '你知道对方的出生信息，独立生成合盘。对方无需注册。',
  bond_mode_resonance: '共振',
  bond_mode_resonance_desc: '通过邮件邀请对方加入，双方各自填写生辰，共同守护隐私。',
  bond_target_name: '对方姓名',
  bond_target_name_placeholder: '输入名字或昵称',
  bond_relationship: '关系',
  bond_label_spouse: '配偶',
  bond_label_partner: '恋人',
  bond_label_parent: '父母',
  bond_label_child: '子女',
  bond_label_sibling: '兄弟姐妹',
  ...
  bond_demo_bond: '羁绊',
  bond_label_custom: '自定义',
  bond_label_custom_placeholder: '输入自定义关系',
  bond_birth_date: '出生日期',
  bond_birth_time: '出生时辰',
  bond_gender: '性别',
  bond_birth_city: '出生城市',
  bond_city_placeholder: '搜索城市名',
  bond_target_email: '对方邮箱',
  bond_email_placeholder: 'name@example.com',
  bond_message: '附言',
  bond_message_placeholder: '写一段话给TA...',
  bond_email_required_hint: '共振模式需要对方邮箱来发送邀请',
  bond_resonance_sending_from: '发送自：',
  bond_resonance_bind_email_hint: '请先在 设置 → 邮箱 中绑定邮箱后再发送邀请。',
  bond_cost_label: '本次消耗',
  bond_submit_solo: '开始默念',
  bond_submit_resonance: '发送邀请',
  bond_invite_sent_title: '邀请已发送',
  bond_invite_sent_desc: '对方将收到邮件邀请，接受后即可查看合盘结果。',
  bond_limit_title: '合盘额度已满',
  bond_limit_desc: '免费用户最多创建 3 个合盘关系。升级 Pro 解锁无限合盘。',
  trial_badge: '试用中',
  trial_days_remaining: '试用剩余 {days} 天',
  trial_expired: '试用期已结束',
  chat_trial_daily_limit: '试用期每日 AI 对话次数已达上限',
  bond_status_pending: '等待中',
  bond_view_reading: '查看解读',
  bond_waiting_response: '等待对方回应',
  bonds_empty_hint: '还没有关系，点击 + 建立第一个',
  bonds_empty_readings_explain:
    '个人命书与已保存的合盘在「命册 › 命运 › 深度解读」。此处的缘分用于「默念」或「共振」连接。',
  bonds_empty_readings_cta: '前往命册 · 深度解读',
  bond_invite_not_found: '邀请不存在或已失效',
  bond_accepted_title: '已接受',
  bond_accepted_desc: '合盘计算已完成，返回缘分页查看结果。',
  bond_declined_title: '已婉拒',
  bond_declined_desc: '你婉拒了此次邀请，对方铜钱已退还。',
  bond_go_to_bonds: '查看缘分',
  bond_delete_title: '删除关系',
  bond_delete_confirm: '确定删除与 {name} 的关系？',
  bond_delete_action: '删除',
  bond_invite_from: '邀请来自',
  bond_invite_expires: '过期时间',
  bond_accept_birth_prompt: '请填写你的出生信息以完成合盘计算',
  bond_confirm_accept: '确认接受',
  bond_accept: '接受邀请',
  bond_decline: '婉拒',
  bond_ritual_instruction: '请默念对方名字三遍',
  bond_ritual_three: '三',
  bond_ritual_two: '二',
  bond_ritual_one: '一',
  bond_share_scan_hint: '扫码查看完整解读',
  bond_briefing_locked: '更多维度解锁完整解读可见',
  bond_set_your_label: '设置你的关系标签',
  bond_label_hint: '选择一个标签…',
  optional: '可选',
  coins: '铜钱',
  ...
  bond_share_link: '分享链接',
  bond_share_image: '分享海报',
  tab_me: '我',
  ...
  bond_stage_label: '感情阶段',
  bond_stage_crush: '青梅',
  bond_stage_dating: '恋爱',
  bond_stage_committed: '确定',
  bond_stage_engaged: '订婚',
