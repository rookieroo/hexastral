  ...
  return (
    <main className="flex min-h-screen flex-col items-center p-6 md:p-24 bg-white text-gray-900">
      ...
      <div className="mb-16 grid text-center lg:max-w-6xl lg:w-full lg:mb-0 lg:grid-cols-3 lg:text-left gap-6">
        ...
        <div
          className="rounded-lg border border-dashed border-gray-300 px-5 py-4 bg-gray-50 opacity-75"
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50 mx-auto lg:mx-0`}>
            AI-powered page builder for Shopify merchants. Describe your product, get a publishable page.
          </p>
        </div>
      </div>
      ...
      <div className="w-full max-w-5xl mt-16 mb-8 rounded-xl border border-gray-200 bg-gray-50 p-8">
        ...
        <p className="text-sm text-gray-600 leading-relaxed">
          UseONE, LLC is an independent software company building productivity and creator tools
          for individuals and small businesses. We are incorporated in the United States and
          develop all products in-house. Our mission is to make powerful digital infrastructure
          accessible to everyone — from personal knowledge management to AI-powered content
          creation and e-commerce.
        </p>
        <p className="text-sm text-gray-500 mt-3">
          For support, billing inquiries, or any questions about our products, please contact us at{' '}
          <a href="mailto:support@useone.tech" className="underline hover:text-gray-900 transition-colors">
            support@useone.tech
          </a>
      ...
      <footer className="w-full border-t border-gray-200 mt-auto py-8 flex flex-col items-center gap-4 text-sm text-gray-500">
        <div className="flex gap-6 flex-wrap justify-center">
           ...
           <Link href="/terms" className="hover:underline hover:text-gray-900 transition-colors">Terms of Use</Link>
           <a href="mailto:support@useone.tech" className="hover:underline hover:text-gray-900 transition-colors">Support</a>
        </div>
