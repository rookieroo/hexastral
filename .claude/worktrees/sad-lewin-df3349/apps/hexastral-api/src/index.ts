...
// 易经
app.route('/api/yiching/divination', divinationRoutes)
...
// Dev-only — gated by ENVIRONMENT !== 'production' inside the router
...
const _rpcApp = new Hono<AppEnv>()
  ...
  .route('/api/yiching/divination', divinationRoutes)
...
export default {
  ...
  /** Daily cron (04:00 UTC): expire stale bond invitations.
