...
export const zodiacPages: Record<ZodiacSlug, { han: string; pinyin: string; blurb: string }> = {
  rat: { han: '鼠', pinyin: 'Shǔ', blurb: 'Quick, resourceful, socially alert — and sensitive to fine‑grained risk.' },
  ox: { han: '牛', pinyin: 'Niú', blurb: 'Stamina, integrity, and long timelines; watch for stubborn lag when context shifts.' },
  tiger: { han: '虎', pinyin: 'Hǔ', blurb: 'Courage, initiative, charisma; pair with recovery rituals to avoid burnout bids.' },
  rabbit: { han: '兔', pinyin: 'Tù', blurb: 'Diplomatic, aesthetic, harmonic — excels when contexts reward tact over blunt force.' },
  dragon: { han: '龙', pinyin: 'Lóng', blurb: 'Magnetic ambition and mythic stakes; grounding practices keep dragons effective, not chaotic.' },
  snake: {
    han: '蛇',
    pinyin: 'Shé',
    blurb: 'Strategic intuition, persuasive calm, secrecy as a skill — clarity contracts prevent misunderstandings.',
  },
  horse: { han: '马', pinyin: 'Mǎ', blurb: 'Freedom‑loving mover; thrives with autonomy metrics and spaced deadlines.' },
  goat: {
    han: '羊',
    pinyin: 'Yáng',
    blurb: 'Co‑creative caretaker archetype — strong rapport, benefits from explicit reciprocity cues.',
  },
  monkey: { han: '猴', pinyin: 'Hóu', blurb: 'Adaptive wit, improvisation, tactical humor; systems help finish what wit starts.' },
  rooster: { han: '鸡', pinyin: 'Jī', blurb: 'Standards, showmanship, integrity signaling; soften edges when trust is scarce.' },
  dog: {
    han: '狗',
    pinyin: 'Gǒu',
    blurb: 'Loyalty, sentinel instincts, ethic of protection — beware anxiety loops about loyalty tests.',
  },
  pig: { han: '猪', pinyin: 'Zhū', blurb: 'Sincerity, savoring life, stamina for hospitality; boundaries protect generosity.' },
}
