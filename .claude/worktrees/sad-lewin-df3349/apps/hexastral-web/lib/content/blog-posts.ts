...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    title: 'What is Zi Wei Dou Shu (紫微斗数)? The “Eastern Astrology” Frame',
    description:
      'Twelve palaces, star combinations, and decade cycles — mapped to language Co-Star users already understand.',
    date: '2026-05-08',
    appCta: 'starpalace',
    body: `Zi Wei Dou Shu (紫微斗数, “Purple Star Astrology”) plots twelve life palaces from birth data — a structural cousin to Western house-based natal charts.
...
HexAstral presents this as **StarPalace** on iOS: daily-style palace insights, decade timelines (大运 dà yùn), and AI copy that keeps **source terms** visible for trust and mystique.
...
This article is for cultural orientation only — not a prediction service.`,
  },
  {
    ...
    date: '2026-05-08',
    appCta: 'eightpillars',
    body: `MBTI sorts cognitive style. Ba Zi (八字, “Eight Characters” / Four Pillars of Destiny) sorts the **Five Elements (五行 wǔ xíng)** pattern around your **Day Master (日元 rì yuán)** — the stem of the day pillar.

Similarity: both are **typing systems** that compress complexity into a handle you can reason about.

Difference: Ba Zi ties the model to a **calendar clock** (year, month, day, hour pillars) and studies flow through **Luck Pillars (大运 / 流年)** over time.
...
**Liu Yao (六爻)** divination animates the lines with coin or seed randomness; the pattern of “old” and “young” lines determines **changing lines (动爻)** and the **derived hexagram**.

Treat the result as a structured mirror for your question — not an external authority.

**CoinCast** (coming to the portfolio) focuses on this ritual on iPhone; **HexAstral** already ships a full oracle flow today.`,
  },
  {
...
- **Timing** — whether you are aligned or cross-current in decade/annual luck
...
Scores describe **tendency**, not compatibility forever. People change; luck cycles change.`,
  ...
  {
    slug: 'year-of-the-horse-2026-snake-bridge',
    title: 'Chinese Zodiac Years and the Calendar Border (生肖 Shēng Xiào)',
    description:
      'Your “zodiac year” follows the lunar new year boundary — not always January 1. Here is why that matters.',
    date: '2026-05-08',
    appCta: 'hexastral',
    body: `The twelve animals (十二生肖) rotate on a **lunar-year** boundary anchored at **Li Chun (立春)** or cultural Spring Festival conventions depending on practitioner school.

If you were born in January or early February, **double-check** the year animal before meme-sharing your sign.
...
When in doubt, use a **Ba Zi / Zi Wei** app with true solar time and city correction — not a single “zodiac meme.”`,
  },
]
