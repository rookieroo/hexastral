...
> = {
  stellar: { en: 'Stellar Chart', zh: '星宫命理', icon: '☆', color: '#7b5ea7' },
  natal: { en: 'Natal Chart', zh: '命格命理', icon: '乾', color: '#c4a862' },
  yiching: { en: 'I Ching Divination', zh: '易经占卜', icon: '兑', color: '#C4A862' },
  fate: { en: 'Destiny Report', zh: '综合命运报告', icon: '命', color: '#7b5ea7' },
