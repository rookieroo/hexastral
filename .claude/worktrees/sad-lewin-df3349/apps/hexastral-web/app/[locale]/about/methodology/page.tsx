  ...
  const faq = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'HexAstral flagship plus portfolio satellites — FaceOracle, StarPalace, SoulMatch, FengShui AI, DreamOracle, EightPillars, CoinCast — all share astro-core computations and DDL-aware growth plumbing.',
        },
      },
      {
        '@type': 'Question',
    ...
    <GrowthShell nav={nav}>
      <article>
        ...
        <p style={{ color: 'var(--color-ivory-dim)', lineHeight: 1.75 }}>
          We treat classical texts ( Zhou Yi · 周易, Zi Wei tomes, Ba Zi anthologies ) as annotated priors —
          Gemini-class models narrate within guardrails referencing those priors explicitly.
        </p>
        <h2 style={{ fontSize: '1.1rem', color: 'var(--color-gold)', fontWeight: 500 }}>Three promises</h2>
        <ol style={{ paddingLeft: '1.25rem', lineHeight: 1.7, color: 'var(--color-ivory)' }}>
          ...
          <li>Show the seams — differentiate deterministic chart math vs. interpretive narration.</li>
        ...
        <p style={{ fontSize: '0.8rem', color: 'var(--color-ivory-muted)', marginTop: '2rem' }}>
          Operational note: pairing growth UTMs persists for 30 days via <code>growth_utm</code> middleware cookies to
          align paid social + DDL sessions.
        </p>
      </article>
    </GrowthShell>
  )
