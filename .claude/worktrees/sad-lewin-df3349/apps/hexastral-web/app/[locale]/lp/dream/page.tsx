...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: locale === 'en' ? 'https://hexastral.com/lp/dream' : `https://hexastral.com/${locale}/lp/dream`,
    },
  }
}
  ...
  return (
    <>
      ...
      <p style={{ color: 'var(--color-ivory-dim)' }}>
        Google Search intents (“dream interpretation”, “water dream meaning”) ladder into DreamOracle. Until launch,
        keep capturing UTMs via{' '}
        <code style={{ fontSize: '0.82rem' }}>/api/ddl</code> + Growth cookies.
      </p>
      <Link href='/tools/dream' style={{ color: 'var(--color-gold)', display: 'block', marginBottom: '1.25rem' }}>
