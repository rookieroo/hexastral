...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: locale === 'en' ? 'https://hexastral.com/lp/face' : `https://hexastral.com/${locale}/lp/face`,
    },
  }
}
...
export default async function LpFacePage() {
  return (
    <>
      <p style={{ color: 'var(--color-gold)', letterSpacing: '0.2em', marginBottom: '0.35rem', fontSize: '0.75rem' }}>
      ...
      <p style={{ color: 'var(--color-ivory-dim)', lineHeight: 1.7 }}>
        Portrait flows + Gemini-class vision scaffolding turn classical facial zones into structured notes —
        entertainment-grade, ethics-forward.
      </p>
      <DownloadCTA
