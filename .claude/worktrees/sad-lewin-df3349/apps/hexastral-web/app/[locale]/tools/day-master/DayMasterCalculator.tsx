        ...
        >
          ...
          >
            {[pillars.year, pillars.month, pillars.day, pillars.hour].map((p, i) => (
              ...
              <div key={i} style={{ padding: '0.5rem', background: 'rgba(0,0,0,0.2)', borderRadius: 8 }}>
                <div>{p.stem}</div>
          ...
          <p style={{ fontSize: '0.78rem', color: 'var(--color-ivory-muted)', marginTop: '0.75rem' }}>
            Uses simplified Gan Zhi boundaries (Gregorian approximation). HexAstral iOS applies solar terms,
            optional true solar time, and Luna conversion for prod readings.
          </p>
        </div>
      ) : null}
