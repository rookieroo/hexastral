...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description:
      'Protected dual-birth preview of elemental synergy. Unlock detailed Bond readings in HexAstral · SoulMatch.',
    alternates: {
      canonical:
        locale === 'en'
  ...
  return (
    <>
      ...
      <p style={{ color: 'var(--color-ivory-dim)', lineHeight: 1.65 }}>
        <strong>He Pan (合盘)</strong> overlays two Ba Zi / Zi Wei charts. This web flow returns a guarded score preview
        (Cloudflare Turnstile). Consent matters: enter data you are allowed to use.
      </p>
      <CompatibilityTeaser />
    </>
  )
