  ...
  return (
    <>
      <h1 style={{ fontSize: '1.75rem', fontWeight: 400, marginTop: 0 }}>
        Day Master preview <span style={{ color: 'var(--color-ivory-dim)', fontSize: '1rem' }}>八字</span>
      </h1>
      <p style={{ color: 'var(--color-ivory-dim)', lineHeight: 1.65 }}>
        ...
        <em> Ri Yuan / 日元 </em>). It anchors Element psychology in Ba Zi — like a sun sign backbone, tuned
        for Five Elements rather than planets.
      </p>
      <DayMasterCalculator />
    </>
  )
