...
export default function FaceReadingTeaserPage() {
  return (
    <>
      <h1 style={{ fontSize: '1.75rem', fontWeight: 400, marginTop: 0 }}>Physiognomy teaser · 面相</h1>
      <p style={{ color: 'var(--color-ivory-dim)', lineHeight: 1.65 }}>
        <strong>FaceOracle</strong> will pair camera intake with Gemini-class vision routers for anatomical structuring,
        then layer interpretive prose that cites textual traditions instead of spooky guessing.
      </p>
