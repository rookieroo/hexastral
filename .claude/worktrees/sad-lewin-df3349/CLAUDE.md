...
- **Mobile**: Expo 54 + React Native 0.81 (2 flagships, 3 satellites)
...
```
apps/        hexastral-api · hexastral-app · hexastral-web · useone-tech
             yuan-app · coin-cast-app · dream-oracle-app · face-oracle-app
...
2. **Read [docs/decisions/](docs/decisions/)** ADRs — naming + brand architecture.
3. **Skim the latest closed PR**(s) on GitHub to see what just shipped.
4. If working on Yuán: also read [packages/scenario-yuan/README.md](packages/scenario-yuan/README.md) and [MIGRATION.md](packages/scenario-yuan/MIGRATION.md).
...
- Don't refactor `apps/hexastral-app/(bonds)/` unless you've read [scenario-yuan/MIGRATION.md](packages/scenario-yuan/MIGRATION.md).
