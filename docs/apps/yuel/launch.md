# Kindred / Kindred — June 2026 launch checklist

**Bundle:** `com.hexastral.kindred` · **Display name:** Kindred (or Kindred in CJK locales)
...
- Bonds receive path: when a user signs into Kindred with an identity that has bonds already in the portfolio, they appear (the `transferAuspicePeopleToBonds` push from Auspice is what populates them)
...
- [ ] In Kindred: sign in with the same Apple/Google account → confirm the 亲友 shows up as a bond
...
- [ ] On-device smoke: cold-install Kindred → sign in → bonds appear → run a 合婚 reading → subscription gating works
