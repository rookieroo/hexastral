...
export default async function FengShuiGuidePage({ params }: Props) {
  ...
  return (
    <article>
      ...
      <p style={{ lineHeight: 1.75, color: 'var(--color-ivory)', fontSize: '0.95rem' }}>
        {pg.blurb}
      </p>
      <p style={{ fontSize: '0.82rem', color: 'var(--color-ivory-muted)', marginTop: '1rem' }}>
        Architectural, electrical, or structural decisions still belong to licensed professionals.
        FengShui AI is being designed for spatial journaling + classical overlays — not supernatural
        guarantees.
      </p>
      <DownloadCTA
