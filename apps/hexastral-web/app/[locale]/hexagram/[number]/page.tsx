  ...
  return (
    <article style={{ lineHeight: 1.7 }}>
      ...
      <header>
        ...
        <p
          style={{ color: 'var(--color-ivory-dim)', fontSize: '0.92rem', marginBottom: '1.75rem' }}
        >
          Upper trigram: {h.upperTrigram} · Lower trigram: {h.lowerTrigram}
        </p>
      </header>
      <section
        style={{ border: '1px solid rgba(245,240,232,0.08)', padding: '1rem', borderRadius: 14 }}
      >
        <h2 style={{ fontSize: '1rem', color: 'var(--color-gold)', fontWeight: 500 }}>Judgment</h2>
        <pre style={{ margin: '0.5rem 0 1rem', fontFamily: 'inherit', whiteSpace: 'pre-wrap' }}>
          {h.judgment}
        </pre>
      ...
      <section
        style={{ marginTop: '1.75rem', color: 'var(--color-ivory-muted)', fontSize: '0.86rem' }}
      >
