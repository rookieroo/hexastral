...
export async function generateMetadata({ params }: NumerologyLandingPageProps): Promise<Metadata> {
...
const COPY: Record<string, NumerologyLandingCopy> & { en: NumerologyLandingCopy } = {
  en: {
