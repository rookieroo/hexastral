...
const STRINGS: Record<Locale, LegalUiStrings> = {
  en: {
    ...
    privacySubheading:
      'Applies to HexAstral, Yuel, Yuun, Yaul, and all satellite apps published by UseONE, LLC',
  ...
  ja: {
    ...
    privacySubheading:
      'UseONE, LLC が提供する HexAstral、Yuel、Yuun、Yaul、およびすべてのサテライトアプリに適用されます',
    backToHome: '← ホームへ戻る',
  ...
  zh: {
    ...
    privacySubheading: '适用于 UseONE, LLC 出品的 HexAstral、Yuel、Yuun、Yaul 以及所有卫星应用',
    backToHome: '← 返回首页',
  ...
  tw: {
    ...
    termsPageTitle: '使用條款',
    lastUpdatedLabel: '最近更新',
    privacySubheading: '適用於 UseONE, LLC 出品的 HexAstral、Yuel、Yuun、Yaul 以及所有衛星應用',
    backToHome: '← 返回首頁',
