...
const STRINGS: Record<Locale, LegalUiStrings> = {
  en: {
    ...
    privacySubheading:
      'Applies to HexAstral, Kindred, Fēng, Cycle, and all satellite apps published by UseONE, LLC',
  ...
  ja: {
    ...
    privacySubheading:
      'UseONE, LLC が提供する HexAstral、Kindred、Fēng、Cycle、およびすべてのサテライトアプリに適用されます',
    backToHome: '← ホームへ戻る',
