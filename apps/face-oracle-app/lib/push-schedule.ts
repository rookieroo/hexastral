/**
 * Local notifications for FaceOracle Pro (ADR-0028):
...
const SCHEDULED_KEY = 'faceoracle_push_scheduled_v1'
...
export async function scheduleFaceOraclePush(input: ScheduleFacePushInput): Promise<void> {
