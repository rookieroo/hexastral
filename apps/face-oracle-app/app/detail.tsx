...
import { FaceReadSharePoster } from '@zhop/portfolio-posters'
...
export default function FaceReadDetailScreen() {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <FaceReadSharePoster
        shareUrl='https://www.hexastral.com/en/lp/face'
        headline='Face feature reading'
      />
    </ScrollView>
  )
}
