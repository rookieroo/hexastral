/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2628b9a96c61dfe7727119e516b9f6c2)
// Runtime types generated with workerd@1.20260508.1 2025-09-03 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		FENG_ANALYZE_QUEUE: Queue;
		FACEORACLE_READING_QUEUE: Queue;
		AD_CONVERT_QUEUE: Queue;
		...
		ALLOW_DEV_PRO: "0";
		SVC_GEOCODE: Fetcher /* hexastral-svc-geocode */;
		SVC_NOTIFY: Fetcher /* svc-notify */;
		SVC_ASTRO: Fetcher /* svc-astro */;
		SVC_MAILER: Fetcher /* hexastral-svc-mailer */;
		SVC_ADMIN_NOTIFY: Fetcher /* svc-admin-notify */;
		SVC_FENG: Fetcher /* hexastral-svc-feng */;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "TURNSTILE_SITE_KEY" | "ARCHETYPE_CACHE_VERSION" | "ALLOW_DEV_PRO">> {}
}
