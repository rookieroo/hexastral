...
const PUSH_STRINGS: Record<string, Record<string, string>> = {
  ...
  bond_matched_body: {
    zh: '你的联系人已加入 Yuel！',
    'zh-Hant': '你的聯繫人已加入 Yuel！',
    en: 'Your contact joined Yuel',
    ja: '連絡先が Yuel に参加しました！',
    ko: '연락처가 Yuel에 가입했습니다',
    de: 'Dein Kontakt ist Yuel beigetreten',
    es: 'Tu contacto se unió a Yuel',
    vi: 'Liên hệ của bạn đã tham gia Yuel!',
    th: 'ผู้ติดต่อของคุณเข้าร่วม Yuel แล้ว!',
  },
  ...
  bond_accepted_body: {
    zh: '你的合盘解读已就绪，开启 Yuel 查看福报缘分。',
    'zh-Hant': '你的合盤解讀已就緒，開啟 Yuel 查看福報緣分。',
    en: 'Your compatibility reading is ready. Open Yuel to see the full analysis.',
    ja: '合盤解読が完成しました。Yuel を開いてご確認ください。',
    ko: '궁합 해석이 준비되었습니다. Yuel 앱을 열어 확인하세요.',
    de: 'Deine Kompatibilitätsanalyse ist bereit. Öffne Yuel.',
    es: 'Tu lectura de compatibilidad está lista. Abre Yuel.',
    vi: 'Bản đọc hợp bàn đã sẵn sàng. Mở Yuel để xem.',
    th: 'การวิเคราะห์ความเข้ากันพร้อมแล้ว เปิด Yuel เพื่อดู',
  },
  ...
  bond_gifted_body: {
    zh: '你们的合盘完整解读已解锁，开启 Yuel 查看所有维度。',
    'zh-Hant': '你們的合盤完整解讀已解鎖，開啟 Yuel 查看所有維度。',
    en: 'Your partner shared the full compatibility reading with you. Open Yuel to view it.',
    ja: '合盤の完全な解読が共有されました。Yuel を開いてご確認ください。',
    ko: '파트너가 전체 궁합 분석을 공유했습니다. Yuel 앱을 열어 확인하세요.',
    de: 'Dein Partner hat die vollständige Kompatibilitätsanalyse geteilt. Öffne Yuel.',
    es: 'Tu pareja compartió el análisis completo contigo. Abre Yuel.',
    vi: 'Đối tác của bạn đã chia sẻ phân tích tương thích đầy đủ. Mở Yuel để xem.',
    th: 'คู่ของคุณแชร์การวิเคราะห์ความเข้ากันทั้งหมดกับคุณแล้ว เปิด Yuel',
  },
