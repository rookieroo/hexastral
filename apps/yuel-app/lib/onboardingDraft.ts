...
export interface OnboardingDraft {
  ...
  /** Resolved geo from CityPicker — kept alongside the human-readable city
   *  so backend can use precise coordinates for 真太阳时 correction without
   *  re-geocoding. Null when the user has not picked from suggestions yet. */
