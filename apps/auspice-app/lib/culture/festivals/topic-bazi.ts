...
export const TOPIC_BAZI: FestivalContent = {
  ...
  sections: {
    'zh-Hans': [
      ...
      {
        title: '用神与忌神',
        body: '八字讲究五行平衡。能扶助日主、补其所缺、令全局趋于中和的五行，称「用神」（喜用）；反之，加剧失衡、损耗日主的，称「忌神」。用神是论命的核心落点：行运逢用神则顺、逢忌神则滞。本 App「对你而言」判断某日宜忌参考、make-if 衡量某年是否适合决策，底层都在问同一件事——这一天/这一年，于你是用神得力，还是忌神当值。',
      },
    ],
    'zh-Hant': [
      {
      ...
      {
        title: '用神與忌神',
        body: '八字講究五行平衡。能扶助日主、補其所缺、令全局趨於中和的五行，稱「用神」（喜用）；反之，加劇失衡、損耗日主的，稱「忌神」。用神是論命的核心落點：行運逢用神則順、逢忌神則滯。本 App「對你而言」判斷某日宜忌參考、make-if 衡量某年是否適合決策，底層都在問同一件事——這一天/這一年，於你是用神得力，還是忌神當值。',
      },
    ],
    ja: [
      {
