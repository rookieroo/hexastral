...
const zhHans: Strings = {
  ...
  unlockMore: '解锁更多',
  proTitle: 'Yuun Pro',
  proSubtitle: '命书深读 · 完整人生时间线 ·「假如」推演 · 每日对你而言',
  proBenefits: [
    '你的命书 · 八字+紫微深度解读 + AI 追问',
...
const zhHant: Strings = {
  ...
  unlockMore: '解鎖更多',
  proTitle: 'Yuun Pro',
  proSubtitle: '命書深讀 · 完整人生時間線 ·「假如」推演 · 每日對你而言',
  proBenefits: [
    '你的命書 · 八字+紫微深度解讀 + AI 追問',
...
const ja: Strings = {
  ...
  unlockMore: 'もっと見る',
  proTitle: 'Yuun Pro',
  proSubtitle: '命書の深掘り · 人生タイムライン全期間 ·「もしも」· 毎日あなたへ',
  proBenefits: [
    'あなたの命書 · 四柱推命+紫微斗数の深掘り + AI で追加質問',
...
const en: Strings = {
  ...
  proTitle: 'Yuun Pro',
  proSubtitle: 'Your Reading in depth · life timeline · what-if paths · daily For-you',
  proBenefits: [
    'Your Reading — a deep Ba Zi + Zi Wei study of your chart, with AI follow-up',
