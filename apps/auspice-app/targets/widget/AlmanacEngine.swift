...
enum AlmanacEngine {
  ...
  /// 建除 → base 宜 / 忌 — must mirror packages/astro-core OFFICER_YIJI (canonical CJK).
  /// Offline fallback only; modern display comes from App Group / bootstrap strings.
  static let officerYiJi: [String: (yi: String, ji: String)] = [
    "建": ("出行 · 祈福 · 求财 · 见贵", "动土 · 破土 · 安葬"),
    "除": ("除服 · 疗病 · 出行 · 沐浴", "嫁娶 · 开市 · 安床"),
    "满": ("祭祀 · 祈福 · 开市 · 交易 · 纳财", "安葬 · 求医 · 栽种"),
    "平": ("修造 · 嫁娶 · 安床 · 涂泥", "求医 · 栽种"),
    "定": ("嫁娶 · 开市 · 入学 · 修造 · 安床", "诉讼 · 出行 · 求医"),
    "执": ("嫁娶 · 立券 · 交易 · 捕捉 · 修造", "开市 · 移徙 · 出行"),
    "破": ("求医 · 破屋 · 拆卸", "嫁娶 · 开市 · 立券 · 动土 · 出行"),
    "危": ("祭祀 · 安床", "出行 · 嫁娶 · 登高 · 行船"),
    "成": ("开市 · 嫁娶 · 出行 · 入学 · 动土 · 立券 · 入宅", "诉讼"),
    "收": ("嫁娶 · 纳财 · 入仓 · 纳畜 · 交易", "安葬 · 出行 · 开市"),
    "开": ("开市 · 出行 · 入学 · 修造 · 动土 · 祈福", "安葬"),
    "闭": ("安葬 · 补垣 · 塞穴 · 筑堤", "开市 · 出行 · 求医 · 动土"),
  ]
