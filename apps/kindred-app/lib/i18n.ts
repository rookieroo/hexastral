...
export const translations: Translations = {
  en: {
    ...
    'paywall.subtitle': 'Unlock the full reading on every bond.',
    ...
    'paywall.bullet.unlimited': 'Unlimited full readings',
