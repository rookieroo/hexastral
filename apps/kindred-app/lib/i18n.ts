...
export const translations: Translations = {
  en: {
    ...
    'unlock.inviteHint': 'A new friend who joins through you reads their first bond with you for free',
  ...
  zh: {
    ...
    'unlock.inviteHint': '新朋友通过你的邀请加入，你们的第一份合盘免费',
  ...
  'zh-Hant': {
    ...
    'unlock.inviteHint': '新朋友透過你的邀請加入，你們的第一份合盤免費',
  ...
  ja: {
    ...
    'unlock.inviteHint': 'あなたの招待で新しい友達が参加すると、最初の相性鑑定が無料に',
