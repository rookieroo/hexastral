...
export const translations: Translations = {
  en: {
    ...
    'paywall.subtitle': 'Stay with your readings — ask, replay, and keep in tune.',
    'paywall.subtitleChat': "You've used your free messages for this reading.",
    'paywall.subtitleChapters': 'Keep exploring — follow-up, timeline & what-if.',
    'paywall.bullet.unlimited': 'Unlimited AI follow-up on any reading',
    'paywall.bullet.deep': 'Life timeline & what-if paths',
    ...
    'paywall.bullet.support': 'Cycle & node alerts, plus a more generous allowance',
  ...
  zh: {
    ...
    'paywall.subtitle': '让命书活起来 · 追问、推演与提醒',
    'paywall.subtitleChat': '本篇合盘的免费消息已用完。',
    'paywall.subtitleChapters': '继续探索这篇 · 追问 · 时间线 ·「假如」',
    'paywall.bullet.unlimited': '划词追问 · 不限次数',
    'paywall.bullet.deep': '人生时间线 ·「假如」推演',
    ...
    'paywall.bullet.support': '流年节点提醒 · 更宽裕的额度',
    'paywall.monthly': '月度',
    'paywall.annual': '年度',
  ...
  'zh-Hant': {
    ...
    'paywall.subtitle': '讓命書活起來 · 追問、推演與提醒',
    'paywall.subtitleChat': '本篇合盤的免費訊息已用完。',
    'paywall.subtitleChapters': '繼續探索這篇 · 追問 · 時間線 ·「假如」',
    'paywall.bullet.unlimited': '劃詞追問 · 不限次數',
    'paywall.bullet.deep': '人生時間線 ·「假如」推演',
    ...
    'paywall.bullet.support': '流年節點提醒 · 更寬裕的額度',
    'paywall.monthly': '月度',
    'paywall.annual': '年度',
    'paywall.bestValue': '最划算',
    'paywall.cta': '繼續',
  ...
  ja: {
    ...
    'paywall.subtitle': '命書を生かす · 追問・推演・お知らせ',
    'paywall.subtitleChat': 'この相性診断の無料メッセージを使い切りました。',
    'paywall.subtitleChapters': 'この解読を掘り下げる · 追問 · タイムライン ·「もしも」',
    'paywall.bullet.unlimited': 'AI 追問 · 回数無制限',
    'paywall.bullet.deep': '人生タイムライン ·「もしも」推演',
    ...
    'paywall.bullet.support': '運勢の節目通知 · より余裕のある枠',
    'paywall.monthly': '月額',
    'paywall.annual': '年額',
