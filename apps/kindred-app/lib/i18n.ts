...
export const translations: Translations = {
  en: {
    ...
    'primer.roles':
      '甲 is whoever sent the invite; 乙 is whoever accepted. The report speaks to both.',
    'primer.essence':
      'The ink picture is your shared essence drawn as 生 / 克 / 比和 — a shape, not a score.',
    'primer.gesture': 'Press and hold any paragraph to copy, highlight, or ask about it.',
  ...
  zh: {
    ...
    'primer.gesture': '长按任一段落，即可复制、标记或追问。',
    'primer.cta': '开始阅读',
    'primer.more': '完整符号图鉴',
  ...
  'zh-Hant': {
    ...
    'primer.gesture': '長按任一段落，即可複製、標記或追問。',
    'primer.cta': '開始閱讀',
    'primer.more': '完整符號圖鑑',
  ...
  ja: {
    ...
    'primer.gesture': '任意の段落を長押しすると、コピー・マーク・質問ができます。',
    'primer.cta': '読み始める',
    'primer.more': '記号図鑑（全体）',
