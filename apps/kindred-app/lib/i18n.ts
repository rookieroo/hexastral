...
export const translations: Translations = {
  en: {
    ...
    'paywall.subtitle': 'Deeper readings, with more room to explore.',
    'paywall.subtitleChat': "You've used your free messages for this reading.",
    'paywall.subtitleChapters': 'Unlock the full reading — every chapter.',
    'paywall.bullet.unlimited': 'Full readings — all six chapters',
    'paywall.bullet.deep': 'Life timeline, what-if paths & AI follow-up',
    ...
    'paywall.bullet.support': 'A more generous reading & chat allowance',
  ...
  zh: {
    ...
    'paywall.subtitle': '更深入的解读 · 更宽裕的额度',
    'paywall.subtitleChat': '本篇合盘的免费消息已用完。',
    'paywall.subtitleChapters': '解锁完整解读 · 全部章节',
    'paywall.bullet.unlimited': '完整解读 · 全部六章',
    'paywall.bullet.deep': '人生时间线 ·「假如」推演 · AI 追问',
    ...
    'paywall.bullet.support': '更宽裕的解读与对话额度',
    'paywall.monthly': '月度',
    'paywall.annual': '年度',
  ...
  'zh-Hant': {
    ...
    'paywall.subtitle': '更深入的解讀 · 更寬裕的額度',
    'paywall.subtitleChat': '本篇合盤的免費訊息已用完。',
    'paywall.subtitleChapters': '解鎖完整解讀 · 全部章節',
    'paywall.bullet.unlimited': '完整解讀 · 全部六章',
    'paywall.bullet.deep': '人生時間線 ·「假如」推演 · AI 追問',
    ...
    'paywall.bullet.support': '更寬裕的解讀與對話額度',
    'paywall.monthly': '月度',
    'paywall.annual': '年度',
    'paywall.bestValue': '最划算',
    'paywall.cta': '繼續',
  ...
  ja: {
    ...
    'paywall.subtitle': 'より深い解読 · より余裕のある枠',
    'paywall.subtitleChat': 'この相性診断の無料メッセージを使い切りました。',
    'paywall.subtitleChapters': '完全な解読 · 全章を解放',
    'paywall.bullet.unlimited': '完全な解読 · 全6章',
    'paywall.bullet.deep': '人生タイムライン ·「もしも」· AI で追加質問',
    ...
    'paywall.bullet.support': 'より余裕のある解読・対話の枠',
    'paywall.monthly': '月額',
    'paywall.annual': '年額',
