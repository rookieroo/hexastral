...
export const translations: Translations = {
  en: {
    ...
    'reveal.line2': 'has a pattern worth exploring',
    ...
    'makeif.guide.commit':
      'Making it official — a month where your charts read in harmony is a cultural reference for reflection, not a guarantee.',
    'makeif.guide.cohabit':
      'Starting a shared life — months where harmony and your bridging element read strong are worth noting as rhythm references.',
    ...
    'bond.recomputeConfirmBody':
      'This regenerates the report with your current birth and overwrites the current result. Uses 1 of your 3 Pro relationship unlocks this month — cannot be undone.',
    'bond.recomputeFailed': 'Recompute failed. Please try again.',
    'bond.recomputeQuotaExhausted':
      "You have used this month's 3 Pro relationship unlocks. Try again next month, or unlock with a single purchase.",
    ...
    'paywall.bullet.deep': 'AI chat allowance · full timeline & what-if',
    ...
    'readingChat.suggest3': 'What themes stand out this year?',
    'chat.placeholder': 'Type a question…',
    'chat.loading': 'Thinking…',
    'chat.error': 'Something went wrong. Please try again.',
    'chat.proUnlimited': 'Yuel Pro · monthly chat allowance',
    ...
    'chat.dislikeNotAccurate': 'Not accurate',
    'chat.dislikeReport': 'Report objectionable content',
    'chat.report': 'Report',
    'chat.reportConfirmTitle': 'Report this reply?',
    'chat.reportConfirmBody': 'We will review objectionable content.',
    'chat.reportDone': 'Submitted',
    'chat.cancel': 'Cancel',
    'chat.share': 'Share',
    'chat.shareSelectHint': 'Select messages for the share image',
    'chat.generateShareImage': 'Generate image',
    'reading.copy': 'Copy',
  ...
  zh: {
    ...
    'timeline.upsell.body':
      'Yuel Pro 的一部分 —— 未来 15 年关系章节的文化脉络图、近 12 个月流月参考窗口，以及可选的节点提醒。',
    ...
    'timeline.back': '返回',
    'bond.essenceNotScore': '五行意象所呈现的关系形态 —— 不是合盘分数，也不是对谁的评判。',
    'bondList.add': '新缘',
    'bondList.delete': '解缘',
    ...
    'paywall.subtitle': '每月 3 次合盘全开或重算 · 体验层加深 · 邀请不限次',
    'paywall.subtitleChat': '本篇的免费消息已用完。',
    'paywall.subtitleChapters': '解锁完整个人解读 · 全六章',
    'paywall.bullet.unlimited': '每月 3 次完整合盘解锁或按新生辰重算',
    'paywall.bullet.deep': 'AI 追问额度 · 完整时间线与假如',
    ...
    'readingChat.suggest3': '今年有哪些值得留意的主题？',
    'chat.placeholder': '输入你的问题…',
    'chat.loading': '正在思考…',
    'chat.error': '出错了，请稍后再试。',
    'chat.proUnlimited': 'Yuel Pro · 月度追问额度',
    ...
    'chat.like': '有用',
    'chat.dislike': '没用',
    'chat.dislikeNotAccurate': '内容不准',
    'chat.dislikeReport': '举报不当内容',
    'chat.report': '举报',
    'chat.reportConfirmTitle': '举报此回复？',
    'chat.reportConfirmBody': '我们会审核不当内容。',
    'chat.reportDone': '已提交',
    'chat.cancel': '取消',
    'chat.share': '分享',
    'chat.shareSelectHint': '选择要放入分享图的消息',
    'chat.generateShareImage': '生成分享图',
    'reading.copy': '复制',
  ...
  'zh-Hant': {
    ...
    'timeline.upsell.body':
      'Yuel Pro 的一部分 —— 未來 15 年關係章節的文化地圖、近 12 個月流月參考窗口，以及可選的節點提醒。',
    ...
    'timeline.back': '返回',
    'bond.essenceNotScore': '五行意象所呈現的關係形態 —— 不是合盤分數，也不是對誰的評判。',
    'bondList.add': '新緣',
    'bondList.delete': '解緣',
    ...
    'paywall.subtitle': '每月 3 次合盤全開或重算 · 體驗層加深 · 邀請不限次',
    'paywall.subtitleChat': '本篇的免費訊息已用完。',
    'paywall.subtitleChapters': '解鎖完整個人解讀 · 全六章',
    'paywall.bullet.unlimited': '每月 3 次完整合盤解鎖或按新生辰重算',
    'paywall.bullet.deep': 'AI 追問額度 · 完整時間線與假如',
    ...
    'chat.proUnlimited': 'Yuel Pro · 月度追問額度',
    ...
    'chat.like': '有用',
    'chat.dislike': '沒用',
    'chat.dislikeNotAccurate': '內容不準',
    'chat.dislikeReport': '舉報不當內容',
    'chat.report': '舉報',
    'chat.reportConfirmTitle': '舉報此回覆？',
    'chat.reportConfirmBody': '我們會審核不當內容。',
    'chat.reportDone': '已提交',
    'chat.cancel': '取消',
    'chat.share': '分享',
    'chat.shareSelectHint': '選擇要放入分享圖的訊息',
    'chat.generateShareImage': '生成分享圖',
    'reading.copy': '複製',
  ...
  ja: {
    ...
    'timeline.upsell.body':
      'Yuel Pro の一部 —— 今後15年の関係章の文化地図、12か月の流月参考ウィンドウ、任意の節目リマインド。',
    ...
    'timeline.back': '戻る',
    'bond.essenceNotScore':
      '五行の意象が示す関係の形 —— 相性スコアでも、誰かへの判定でもありません。',
    'bondList.add': '新しい縁',
    ...
    'bond.recomputeConfirmBody':
      '現在の出生情報でこの相性を再生成し、今の結果を上書きします。今月の Pro 合盤枠（3回）を1回使います。元に戻せません。',
    'bond.recomputeFailed': '再計算に失敗しました。もう一度お試しください。',
    'bond.recomputeQuotaExhausted':
      '今月の Pro 合盤枠（3回）を使い切りました。来月まで待つか、単発購入で解放できます。',
    ...
    'paywall.subtitle': '毎月3回の合盤解放/再計算 · 体験レイヤー · 招待は回数無制限',
    'paywall.subtitleChat': 'この解読の無料メッセージを使い切りました。',
    'paywall.subtitleChapters': '完全な個人レポートを解放 · 全6章',
    'paywall.bullet.unlimited': '毎月3回の完全合盤解放または再計算',
    'paywall.bullet.deep': 'AI チャット枠 · フル時間軸ともしも',
    ...
    'paywall.bullet.support': '無料ソロ完全合盤2回 · 節目通知 · 高品質エクスポート',
    ...
    'chat.proUnlimited': 'Yuel Pro · 月次チャット枠',
    ...
    'chat.like': '役立つ',
    'chat.dislike': '役立たない',
    'chat.dislikeNotAccurate': '内容が不正確',
    'chat.dislikeReport': '不適切な内容を報告',
    'chat.report': '報告',
    'chat.reportConfirmTitle': 'この返信を報告しますか？',
    'chat.reportConfirmBody': '不適切な内容として確認のうえ対応します。',
    'chat.reportDone': '送信しました',
    'chat.cancel': 'キャンセル',
    'chat.share': '共有',
    'chat.shareSelectHint': '共有画像に入れるメッセージを選択',
    'chat.generateShareImage': '画像を生成',
    'reading.copy': 'コピー',
