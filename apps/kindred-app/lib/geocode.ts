/**
 * Geocode helper — wraps hexastral-api's /api/geocode/search.
 *
 * The route forwards to svc-geocode (offline city DB + Nominatim fallback)
 * and returns GeocodedCity[]. We convert that to the @zhop/core-ui
 * CityRecord shape consumed by <CityPicker>.
 */
