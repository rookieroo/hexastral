    ...
    try {
      ...
      const result = await create({
        ...
        targetBirth: {
          ...
          clockMinutes: draft.otherClockMinutes ?? undefined,
          calibrate: draft.otherCalibrate ?? undefined,
          longitude: draft.otherBirthLng != null ? String(draft.otherBirthLng) : undefined,
          timezoneId: draft.otherBirthTimezone ?? undefined,
        },
