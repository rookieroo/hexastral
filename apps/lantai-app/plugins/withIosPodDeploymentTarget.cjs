/**
 * Bump every CocoaPods target (incl. resource bundles) to the app deployment target.
 * Xcode 16+ rejects pods still pinned at iOS 9–13 (GoogleSignIn, RevenueCat, etc.).
 *
 * Resolve @expo/config-plugins via expo (Bun nests packages).
 */
...
const MARKER = '# @zhop/lantai: align pod deployment targets'
