...
import { DreamOracleMeDevTools } from '@/components/DreamOracleMeDevTools'
...
export default function DreamOracleMeScreen() {
  ...
  const refreshSession = useCallback(() => {
    ...
    void (async () => {
      try {
        ...
        console.warn('[dreamoracle-me] refreshSession failed', err)
        setSession('out')
      }
    })()
  }, [])
  ...
  return (
    ...
    >
      ...
      <SatelliteMePanel
        ...
        emptyText={t('meEmpty')}
        privacyUrl='https://www.hexastral.com/en/privacy/dreamoracle'
        ...
        devtoolsSlot={__DEV__ ? <DreamOracleMeDevTools /> : undefined}
      />
    </SafeAreaView>
  )
}
