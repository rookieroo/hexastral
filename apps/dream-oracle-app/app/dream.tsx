...
export default function DreamStubScreen() {
  ...
  // Source palette from CoreUIProvider so the indigo brand accent
  // (ADR-0004 §1) drives the submit CTA + textarea focus ring.
  // ctaOnAccent maps to bg in dark mode so light text reads on indigo.
  const palette = {
