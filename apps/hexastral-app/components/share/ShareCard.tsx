 ...
 *
 * Phase J · J.3.2: rehomed from `components/bonds/` after the bonds tab was
 * deleted. Sole remaining consumer is `detail/yiching/[id]` — kept as a
 * shared "result-share" primitive since it's domain-agnostic (only the
 * children and copy change per reading type).
 */
