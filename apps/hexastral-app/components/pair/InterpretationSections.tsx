 ...
 * branch, highlights, warnings, advice, summary.
 *
 ...
 * deleted (pair readings stay in hexastral-app; bonds went to yuán via
 * scenario-yuan — see ADR-0008 §"Single-consumer code").
 */
