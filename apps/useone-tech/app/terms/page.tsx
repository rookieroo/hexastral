    ...
    <main className='min-h-screen bg-white text-gray-900 py-16 px-4 sm:px-6 lg:px-8'>
      <div className='max-w-3xl mx-auto prose prose-slate'>
        ...
        <p className='text-sm text-gray-500 mb-8'>
          Version 1.0
          <br />
          Last revised on: January 26, 2026
        </p>

        <p>
          The website located at https://useone.tech (the “<strong>Site</strong>”) is a copyrighted
          work belonging to UseONE, LLC (“<strong>Company</strong>”, “<strong>us</strong>”, “
          <strong>our</strong>”, and “<strong>we</strong>”). Certain features of the Site may be
        ...
        <p>
          These Terms of Use (these “<strong>Terms</strong>”) set forth the legally binding terms
          and conditions that govern your use of the Site. By accessing or using the Site, you are
          ...
          Terms (on behalf of yourself or the entity that you represent). you may not access or use
          the Site or accept the Terms if you are not at least 18 years old. If you do not agree
          with all of the provisions of these Terms, do not access and/or use the Site.
        </p>

        <div className='bg-gray-50 p-6 rounded-lg my-8 border border-gray-200 text-sm'>
          <p className='font-bold mb-2'>
            PLEASE BE AWARE THAT SECTION 10.2 CONTAINS PROVISIONS GOVERNING HOW TO RESOLVE DISPUTES
            BETWEEN YOU AND COMPANY.
          </p>
          <p>
            AMONG OTHER THINGS, SECTION 10.2 INCLUDES AN AGREEMENT TO ARBITRATE WHICH REQUIRES, WITH
            LIMITED EXCEPTIONS, THAT ALL DISPUTES BETWEEN YOU AND US SHALL BE RESOLVED BY BINDING
            AND FINAL ARBITRATION. SECTION 10.2 ALSO CONTAINS A CLASS ACTION AND JURY TRIAL WAIVER.
        ...
        <p>
          <strong>Account Creation.</strong> In order to use certain features of the Site, you must
          register for an account (“<strong>Account</strong>”) and provide certain information about
          yourself as prompted by the account registration form. You represent and warrant that: (a)
          all required registration information you submit is truthful and accurate; (b) you will
        ...
        <h2 className='text-xl font-bold mt-8 mb-4'>2. Access to the Site</h2>
        <p>
          <strong>License.</strong> Subject to these Terms, Company grants you a non-transferable,
          non-exclusive, revocable, limited license to use and access the Site solely for your own
          personal, noncommercial use.
        </p>
        <p>
          <strong>Certain Restrictions.</strong> The rights granted to you in these Terms are
        ...
        <p>
          <strong>No Support or Maintenance.</strong> You acknowledge and agree that Company will
          have no obligation to provide you with any support or maintenance in connection with the
          Site.
        </p>
        <p>
          <strong>Ownership.</strong> Excluding any User Content that you may provide (defined
          below), you acknowledge that all the intellectual property rights, including copyrights,
          patents, trade marks, and trade secrets, in the Site and its content are owned by Company
          or Company’s suppliers. Neither these Terms (nor your access to the Site) transfers to you
          or any third party any rights, title or interest in or to such intellectual property
          rights, except for the limited access rights expressly set forth in Section 2.1. Company
          and its suppliers reserve all rights not granted in these Terms. There are no implied
          licenses granted under these Terms.
        </p>

        <h2 className='text-xl font-bold mt-8 mb-4'>3. User Content</h2>
        <p>
          <strong>User Content.</strong> “<strong>User Content</strong>” means any and all
          information and content that a user submits to, or uses with, the Site (e.g., content in
          the user’s profile or postings). You are solely responsible for your User Content. You
          assume all risks associated with use of your User Content, including any reliance on its
          accuracy, completeness or usefulness by others, or any disclosure of your User Content
          that personally identifies you or any third party. You hereby represent and warrant that
          your User Content does not violate our Acceptable Use Policy (defined in Section 3.3). You
          may not represent or imply to others that your User Content is in any way provided,
          sponsored or endorsed by Company. Since you alone are responsible for your User Content,
          you may expose yourself to liability if, for example, your User Content violates the
          Acceptable Use Policy. Company is not obligated to backup any User Content, and your User
          Content may be deleted at any time without prior notice. You are solely responsible for
          creating and maintaining your own backup copies of your User Content if you desire.
        </p>
        <p>
          <strong>License.</strong> You hereby grant (and you represent and warrant that you have
          the right to grant) to Company an irrevocable, nonexclusive, royalty-free and fully paid,
          ...
          including your User Content in the Site. You hereby irrevocably waive (and agree to cause
          to be waived) any claims and assertions of moral rights or attribution with respect to
          your User Content.
        </p>
        <p>
        ...
        <ul className='list-disc pl-5 my-4 space-y-2'>
          <li>
            ...
            User Content (i) that violates any third-party right, including any copyright,
          ...
          <li>
            ...
            or interfere with any other user’s use and enjoyment of the Site; or (vii) use software
        ...
        <p>
          <strong>Enforcement.</strong> We reserve the right (but have no obligation) to review,
          refuse and/or remove any User Content in our sole discretion, and to investigate and/or
          take appropriate action against you in our sole discretion if you violate the Acceptable
          Use Policy or any other provision of these Terms or otherwise create liability for us or
          any other person.
        </p>

        <h2 className='text-xl font-bold mt-8 mb-4'>4. Indemnification</h2>
        <p>
          ...
          party due to or arising out of (a) your use of the Site, (b) your violation of these
          Terms, (c) your violation of applicable laws or regulations or (d) your User Content.
          Company reserves the right, at your expense, to assume the exclusive defense and control
          of any matter for which you are required to indemnify us, and you agree to cooperate with
          our defense of these claims.
        </p>

        <h2 className='text-xl font-bold mt-8 mb-4'>5. Third-Party Links & Ads; Other Users</h2>
        <p>
          ...
          to Third-Party Links & Ads.
        </p>

        <h2 className='text-xl font-bold mt-8 mb-4'>6. Disclaimers</h2>
        ...
        <h2 className='text-xl font-bold mt-8 mb-4'>7. Limitation on Liability</h2>
        <p className='uppercase text-sm'>
        ...
        <p className='uppercase text-sm mt-4'>
          ...
          HEREIN, OUR LIABILITY TO YOU FOR ANY DAMAGES ARISING FROM OR RELATED TO THESE TERMS (FOR
          ANY CAUSE WHATSOEVER AND REGARDLESS OF THE FORM OF THE ACTION), WILL AT ALL TIMES BE
          LIMITED TO A MAXIMUM OF FIFTY US DOLLARS.
        </p>

        <h2 className='text-xl font-bold mt-8 mb-4'>8. Term and Termination</h2>
        <p>
          Subject to this Section, these Terms will remain in full force and effect while you use
          the Site. We may suspend or terminate your rights to use the Site (including your Account)
          at any time for any reason at our sole discretion, including for any use of the Site in
          violation of these Terms.
        </p>

        <h2 className='text-xl font-bold mt-8 mb-4'>9. Copyright Policy</h2>
        <p>
          ...
          termination, in appropriate circumstances, of users of our online Site who are repeat
          ...
          work, please provide our Copyright Agent with a written notification pursuant to 17 U.S.C.
          § 512(c).
        </p>
        <div className='bg-gray-50 p-6 rounded-lg my-8 border border-gray-200'>
          <p>
            <strong>The designated Copyright Agent for Company is:</strong> Shengming Ding
          </p>
          <p>
            <strong>Address of Agent:</strong> 4023 Kennett Pike #50100, Wilmington, DE 19807 US
          </p>
          <p>
            <strong>Telephone:</strong> (302) 217-0248
          </p>
          <p>
            <strong>Email:</strong> contact@useone.tech
          </p>
        </div>

        <h2 className='text-xl font-bold mt-8 mb-4'>10. General</h2>
        <p>
          <strong>Changes.</strong> These Terms are subject to occasional revision, and if we make
        ...
        <p>
          <strong>Dispute Resolution.</strong> Please read the Arbitration Agreement definitions and
          procedures carefully. It requires you to arbitrate disputes with Company and limits the
        ...
        <p>
          UseONE, LLC
          <br />
          4023 Kennett Pike #50100
          <br />
          Wilmington, DE 19807 US
          <br />
          Email: contact@useone.tech
        </p>
      </div>
    </main>
  )
