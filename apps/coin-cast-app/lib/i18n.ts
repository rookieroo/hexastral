...
const EN = {
  ...
  settingsCoinSkinHint: 'Yang (solid bar) and yin (broken bar) are marked on each cap.',
  skinQingTong: 'Qing bronze',
  skinKangxi: 'Kangxi brass',
  skinTangYin: 'Tang silver',
  skinWarringStates: 'Warring States bronze',
  skinImperialLacquer: 'Imperial lacquer',
  settingsAccountSection: 'Account',
  settingsDeleteAccount: 'Delete account & data',
  settingsDeleteAccountHint: 'Permanently removes your account and reading history. Cannot be undone.',
  ...
  settingsBirthInfoLabel: 'Birth info',
  settingsBirthInfoEmpty: 'Not set',
  settingsProBirthTitle: 'Chart-assisted interpretation (Pro)',
  settingsProBirthHint:
    'Add birth info, then unlock CoinCast Pro or Universe Pro for four-pillars context in readings. Birth info syncs across HexAstral apps.',
  birthInfoTitle: 'Birth info',
  birthInfoSubtitle:
    'Used for chart-assisted readings when you have CoinCast Pro or Universe Pro. Synced across HexAstral apps.',
  birthInfoGuestHint: 'Sign in with Apple to save birth info for personalized readings.',
  ...
  birthTimeLabel: 'Birth hour (shichen)',
  birthTimeUnknown: 'Unknown hour',
  ...
  birthSaved: 'Saved',
  birthSaving: 'Saving…',
  birthHint: 'Required for four-pillars context in Pro readings. Does not change how coins are cast.',
  profileBirthEditCta: 'Edit birth info',
  ...
  navBack: 'Back',
  profileSignOutConfirm: 'Sign out on this device? Reading history stays on the server until you delete your account.',
  stackBeforeCast: 'Before you cast',
  resultOpenDetail: 'Open full interpretation',
  resultReadingId: 'Reading ID: {id}',
  resultPersonalizedNote: 'Chart context used: {pillars}',
  ...
  paywallPlanCastPack1: '1 cast',
  paywallPlanCastPack5: '5 casts',
  paywallPlanCastPack10: '10 casts',
...
const ZH: Record<keyof typeof EN, string> = {
  ...
  settingsCoinSkinHint: '阳面（实线）与阴面（断线）刻在钱面，便于辨阴阳。',
  skinQingTong: '清铜',
  skinKangxi: '康熙通宝',
  skinTangYin: '唐银',
  skinWarringStates: '战国古铜',
  skinImperialLacquer: '朱漆御钱',
  ...
  settingsDeleteAccountBody:
    '将永久删除您的 HexAstral 账号及 CoinCast 解读历史。此操作无法撤销。',
  settingsDeleteAccountContinue: '删除',
  settingsDeleteAccountFailed: '删除失败，请稍后重试。',
  settingsDeleteAccountCancel: '取消',
  settingsBirthInfoLabel: '生辰信息',
  settingsBirthInfoEmpty: '未填写',
  settingsProBirthTitle: '命盘辅助解读（Pro）',
  settingsProBirthHint:
    '先录入生辰，再开通 CoinCast Pro 或 Universe Pro，解读将融入四柱语境。生辰在 HexAstral 各 App 互通。',
  birthInfoTitle: '生辰信息',
  birthInfoSubtitle:
    '开通 CoinCast Pro 或 Universe Pro 后，用于命盘辅助解读。在 HexAstral 各 App 间同步。',
  birthInfoGuestHint: '使用 Apple 登录后可保存生辰，用于个性化解读。',
  birthDateLabel: '出生日期',
  birthCalendarSolar: '公历',
  birthCalendarLunar: '农历',
  birthCalendarLunarHint: '输入农历月日（不区分闰月）。',
  birthTimeLabel: '出生时辰',
  birthTimeUnknown: '时辰不详',
  birthGenderLabel: '性别',
  birthGenderMale: '男',
  birthGenderFemale: '女',
  birthSave: '保存',
  birthSaved: '已保存',
  birthSaving: '保存中…',
  birthHint: 'Pro 解读需四柱语境；不影响摇卦随机性。',
  profileBirthEditCta: '编辑生辰',
  sceneLoading: '场景加载中…',
  ...
  resultPersonalizedNote: '已融入命盘语境：{pillars}',
  ...
  paywallPlanCastPack1: '1 次占',
  paywallPlanCastPack5: '5 次占',
  paywallPlanCastPack10: '10 次占',
...
const ZH_HANT: Record<keyof typeof EN, string> = {
  ...
  settingsCoinSkinHint: '陽面（實線）與陰面（斷線）刻在錢面，便於辨陰陽。',
  skinQingTong: '清銅',
  skinKangxi: '康熙通寶',
  skinTangYin: '唐銀',
  skinWarringStates: '戰國古銅',
  skinImperialLacquer: '朱漆御錢',
  ...
  settingsDeleteAccountBody:
    '將永久刪除您的 HexAstral 帳號及 CoinCast 解讀歷史。此操作無法撤銷。',
  settingsDeleteAccountContinue: '刪除',
  settingsDeleteAccountFailed: '刪除失敗，請稍後重試。',
  settingsDeleteAccountCancel: '取消',
  settingsBirthInfoLabel: '生辰資訊',
  settingsBirthInfoEmpty: '未填寫',
  settingsProBirthTitle: '命盤輔助解讀（Pro）',
  settingsProBirthHint:
    '先錄入生辰，再開通 CoinCast Pro 或 Universe Pro，解讀將融入四柱語境。生辰在 HexAstral 各 App 互通。',
  birthInfoTitle: '生辰資訊',
  birthInfoSubtitle:
    '開通 CoinCast Pro 或 Universe Pro 後，用於命盤輔助解讀。在 HexAstral 各 App 間同步。',
  birthInfoGuestHint: '使用 Apple 登入後可儲存生辰，用於個人化解讀。',
  birthDateLabel: '出生日期',
  birthCalendarSolar: '公曆',
  birthCalendarLunar: '農曆',
  birthCalendarLunarHint: '輸入農曆月日（不區分閏月）。',
  birthTimeLabel: '出生時辰',
  birthTimeUnknown: '時辰不詳',
  birthGenderLabel: '性別',
  birthGenderMale: '男',
  birthGenderFemale: '女',
  birthSave: '儲存',
  birthSaved: '已儲存',
  birthSaving: '儲存中…',
  birthHint: 'Pro 解讀需四柱語境；不影響搖卦隨機性。',
  profileBirthEditCta: '編輯生辰',
  sceneLoading: '場景載入中…',
  ...
  resultPersonalizedNote: '已融入命盤語境：{pillars}',
  resultHexagramTitle: '第{num}卦 {name}',
  detailTitle: '詳細解讀',
...
const JA: Record<keyof typeof EN, string> = {
  ...
  settingsCoinSkinHint: '陽面（実線）と陰面（断線）が銭面に刻まれ、見分けやすくなります。',
  skinQingTong: '清銅',
  skinKangxi: '康熙通宝',
  skinTangYin: '唐銀',
  skinWarringStates: '戦国古銅',
  skinImperialLacquer: '朱漆御銭',
  ...
  settingsBirthInfoLabel: '生年月日',
  settingsBirthInfoEmpty: '未設定',
  settingsProBirthTitle: '命盤を踏まえた解釈（Pro）',
  settingsProBirthHint:
    '生年月日を登録し、CoinCast Pro または Universe Pro で四柱の文脈を解釈に反映。HexAstral 各アプリで共有されます。',
  birthInfoTitle: '生年月日',
  birthInfoSubtitle:
    'CoinCast Pro または Universe Pro で命盤を踏まえた解読に使用。HexAstral 各アプリで同期されます。',
  birthInfoGuestHint: 'Apple でサインインすると生年月日を保存し、個人化解釈に使えます。',
  birthDateLabel: '生年月日',
  birthCalendarSolar: '西暦',
  birthCalendarLunar: '旧暦',
  birthCalendarLunarHint: '旧暦の月日を入力（閏月は区別しません）。',
  birthTimeLabel: '出生時刻（十二支）',
  birthTimeUnknown: '時刻不明',
  birthGenderLabel: '性別',
  birthGenderMale: '男',
  birthGenderFemale: '女',
  birthSave: '保存',
  birthSaved: '保存しました',
  birthSaving: '保存中…',
  birthHint: 'Pro 解読の四柱文脈に使用。コインの出方には影響しません。',
  profileBirthEditCta: '生年月日を編集',
  ...
  resultPersonalizedNote: '命盤の文脈を反映：{pillars}',
  ...
  paywallPlanCastPack1: '1回パック',
  paywallPlanCastPack5: '5回パック',
  paywallPlanCastPack10: '10回パック',
...
const KO: Record<keyof typeof EN, string> = {
  ...
  settingsCoinSkinHint: '양면(실선)과 음면(끊긴 선)이 동전 면에 새겨져 구분하기 쉽습니다.',
  skinQingTong: '청동',
  skinKangxi: '강희통보',
  skinTangYin: '당은',
  skinWarringStates: '전국 고동',
  skinImperialLacquer: '주칠 어전',
  ...
  settingsBirthInfoLabel: '생년월일',
  settingsBirthInfoEmpty: '미설정',
  settingsProBirthTitle: '명반 보조 해석 (Pro)',
  settingsProBirthHint:
    '생년월일을 입력한 뒤 CoinCast Pro 또는 Universe Pro로 사주 맥락이 해석에 반영됩니다. HexAstral 앱 간 공유됩니다.',
  birthInfoTitle: '생년월일',
  birthInfoSubtitle:
    'CoinCast Pro 또는 Universe Pro에서 명반 보조 해석에 사용됩니다. HexAstral 앱 간 동기화됩니다.',
  birthInfoGuestHint: 'Apple로 로그인하면 생년월일을 저장해 맞춤 해석에 사용할 수 있습니다.',
  birthDateLabel: '생년월일',
  birthCalendarSolar: '양력',
  birthCalendarLunar: '음력',
  birthCalendarLunarHint: '음력 월일을 입력하세요(윤달 구분 없음).',
  birthTimeLabel: '출생 시진',
  ...
  birthSaved: '저장됨',
  birthSaving: '저장 중…',
  birthHint: 'Pro 해석의 사주 맥락에 사용됩니다. 동전 점에는 영향을 주지 않습니다.',
  profileBirthEditCta: '생년월일 편집',
  ...
  resultPersonalizedNote: '명반 맥락 반영: {pillars}',
  ...
  paywallPlanCastPack1: '1회 패키지',
  paywallPlanCastPack5: '5회 패키지',
  paywallPlanCastPack10: '10회 패키지',
