...
export default function CoinCastMeScreen() {
  ...
  const refreshSession = useCallback(() => {
    ...
    void (async () => {
      try {
        ...
        console.warn('[coincast-me] refreshSession failed', err)
        setSession('out')
      }
    })()
  }, [])
  ...
  return (
    ...
    >
      ...
      <SatelliteMePanel
        ...
        emptyText={t('meEmpty')}
        privacyUrl='https://www.hexastral.com/privacy/coincast'
        ...
        devtoolsSlot={__DEV__ ? <MeDevTools /> : undefined}
      />
    </SafeAreaView>
  )
}
