...
export function VesselMesh({
  rimColor = coinCastSceneColors.vesselRim,
  bowlColor = coinCastSceneColors.vesselBowl,
}: {
  rimColor?: string
  bowlColor?: string
}) {
  return (
    <group position={[0, 0.02, 0]}>
      ...
      <mesh position={[0, -0.03, 0]}>
        <cylinderGeometry args={[VESSEL_RADIUS * 0.82, VESSEL_RADIUS * 0.52, 0.07, 40, 1, false]} />
