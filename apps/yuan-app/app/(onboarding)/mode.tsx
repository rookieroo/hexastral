  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: yuanDark.bg }}>
      <View style={{ flex: 1, paddingHorizontal: yuanSpacing.screenH, paddingTop: yuanSpacing.xl }}>
        ...
        <Text style={[yuanType.body, { color: yuanDark.textSecondary, marginTop: yuanSpacing.sm }]}>
        ...
        <Pressable onPress={() => void handleNext()} hitSlop={12} style={{ alignSelf: 'flex-end' }}>
          <Text style={yuanPresets.ctaText}>{t(locale, ctaKey)}</Text>
        </Pressable>
        <View style={{ height: yuanSpacing.xl }} />
      </View>
    </SafeAreaView>
  ...
  return (
    ...
    >
      ...
      >
        {selected && (
          <View
            style={{ width: 8, height: 8, borderRadius: 999, backgroundColor: yuanDark.accent }}
          />
        )}
      </View>
      <View style={{ flex: 1, gap: 4 }}>
        ...
        <Text style={[yuanType.caption, { color: yuanDark.textMuted }]}>{subtitle}</Text>
      </View>
    </Pressable>
  )
}
