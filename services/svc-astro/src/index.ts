...
import { relationshipTimelineRoutes } from './routes/relationship-timeline'
...
app.route('/cycle', cycleRoutes) // POST /cycle/explain — 黄历 deep reading (Cycle satellite, C.4)
app.route('/timeline', timelineRoutes) // POST /timeline/explain — 命运时间轴节点深度解读 (B-fate.3)
app.route('/relationship-timeline', relationshipTimelineRoutes) // POST /relationship-timeline/explain — 关系时间轴 (B-yuan.3)
